# [prism→paradex] ขอรูปสวีท AiM เช้า — โยคะเช้าในบ้าน

**Ref images (face ref, บังคับแนบทั้ง 2):**
...
FASHION: Sage green sport bra + high-waisted matching leggings, relaxed athletic fit. Bare feet on yoga mat.

MAKEUP: Minimal fresh no-makeup look, light dewy skin, natural brows.

HAIR: Long dark hair tied in high ponytail, a few loose strands framing face.

POSE: Seated cross-legged meditation pose on yoga mat, hands resting on knees in gentle mudra, calm posture, back straight.

EXPRESSION: Eyes gently closed, serene peaceful expression, soft natural smile.

LIGHTING: Early morning soft golden sunlight streaming through large window from the side, gentle diffused warm natural light, visible natural shadow on mat and wall, not overexposed.

BACKGROUND: Cozy minimalist home living room, lavender yoga mat, small potted monstera plant in corner, soft cream curtains, warm wood floor.
...
**Output (local path ตรงๆ ไม่ต้อง SCP — เครื่องเดียวกัน):**
`/home/jijiclaw/Oracle_Project/Prism/viral-content-bot/platform_social/facebook/ai-in-mind/media/picture/2026-07-02_morning-home-yoga.png`

**เก็บ prompt คู่รูป:** บันทึก prompt จริงที่ใช้ gen (อาจต่างจากที่ส่งเล็กน้อย) ไว้ที่
`/home/jijiclaw/Oracle_Project/Prism/viral-content-bot/platform_social/facebook/ai-in-mind/media/picture/prompts/2026-07-02_morning-home-yoga.txt`

ทำเสร็จแจ้ง Prism กลับด้วยค่ะ 🙏
